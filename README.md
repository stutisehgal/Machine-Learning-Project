# HANDWRITTEN DIGIT RECOGNITION (SVM + OpenCV)
...
This project is licensed under the MIT License - see the [LICENSE.md](https://github.com/stutisehgal/Machine-Learning-Project/blob/master/LICENSE.md) file for details
